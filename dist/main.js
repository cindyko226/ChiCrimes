...
function ready(_ref) {
  ...
  radialGradient.append("stop").attr("offset", "0%").attr("stop-color", color(-1));
  radialGradient.append("stop").attr("offset", "50%").attr("stop-color", color(0));
  radialGradient.append("stop").attr("offset", "100%").attr("stop-color", color(1));
  svg.append("circle").attr("cx", width * 0.65).attr("cy", height * 0.55).attr("r", height * 0.03).style("opacity", 0.7).style("fill", "url(#radial-gradient)").attr('class', 'pulse');
} // .attr("class", 'pulse')
